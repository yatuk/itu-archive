import{$,esc,fmtDate}from"../core/utils.js?v=a4bce4874495";import{state}from"../core/store.js?v=a4bce4874495";import{initReveal}from"../core/reveal.js?v=a4bce4874495";const KNOWN_GAPS={"2024-2025-guz":"Bu dönem ne OBS arşivinde ne de dönem başı arşiv dökümünde bulunuyor: veri kaynağı yok."};export function renderTerms(){$("#terms").innerHTML=state.index.terms.map(e=>{if(e.missing){const t=KNOWN_GAPS[e.slug];return`<article class="termcard reveal missing">
