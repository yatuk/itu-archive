import{$,esc,fmtDate}from"../core/utils.js?v=e26e02d355e4";import{state}from"../core/store.js?v=e26e02d355e4";import{initReveal}from"../core/reveal.js?v=e26e02d355e4";const KNOWN_GAPS={"2024-2025-guz":"Bu dönem ne OBS arşivinde ne de dönem başı arşiv dökümünde bulunuyor: veri kaynağı yok."};export function renderTerms(){$("#terms").innerHTML=state.index.terms.map(e=>{if(e.missing){const t=KNOWN_GAPS[e.slug];return`<article class="termcard reveal missing">
