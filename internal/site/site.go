...
var landingActionDetails = map[string]string{
	...
	"/ders-kaydi-nasil-yapilir/":       "Hazırlıktan kayıt anına kadar resmî ders kayıt sürecini adım adım gör.",
	"/ders-programi-nasil-hazirlanir/": "Ders planından çakışmasız haftalık programa giden yolu adım adım izle.",
	"/terimler-sozlugu/":               "CRN, ÖBS, SİS, Ninova gibi kısaltmaların ne anlama geldiğini gör.",
}
...
var landingPages = []landingPage{
	...
	},
	{
		...
		features:    []string{"Harf notlarını kredi ağırlıklı hesaplar", "Dönem ortalaması ile GANO'yu ayrı gösterir", "OBS transkript metnini yapıştırarak veya PDF yükleyerek notları tarayıcıda aktarır"},
		body: []string{
			...
			"OBS'den aldığın transkript metnini yapıştırabilir veya transkript PDF'ini doğrudan yükleyebilirsin; ikisi de yalnızca tarayıcında işlenir, sunucuya gitmez.",
	...
	},
	{
		...
		features:    []string{"Şube ve CRN'leri haftalık çizelgeye ekler, çakışmaları işaretler", "Alternatif Bul: kısıtlarına uyan alternatif şube kombinasyonlarını otomatik hesaplar", "Programı görsel ve .ics takvim dosyası olarak dışa aktarır"},
		body: []string{
			...
			"Alternatif Bul aracı, seçtiğin dersler için gün, saat aralığı veya öğretim üyesi gibi kısıtlara uyan farklı şube kombinasyonlarını otomatik hesaplar ve karşılaştırmalı listeler.",
	...
	},
	{
		...
		secondary: []landingAction{
			...
			{href: "/ders-kaydi-nasil-yapilir/", label: "Resmî OBS/SİS kayıt sürecini öğren", detail: "Hazırlıktan kayıt anına ve intibak/muafiyete kadar tüm süreci adım adım gör."},
			{href: "/ders-programi-nasil-hazirlanir/", label: "Programını nasıl hazırlayacağını gör", detail: "Ders planından çakışmasız haftalık programa giden yolu adım adım izle."},
			{href: "/terimler-sozlugu/", label: "Terimler sözlüğüne bak", detail: "CRN, ÖBS, SİS gibi kısaltmaların ne anlama geldiğini gör."},
		},
	},
	{
	...
	},
	{
		...
		body: []string{
			...
			"Sınavı .ics olarak indirdiğinde konum bilgisi Google Haritalar linkine dönüştürülür; takvim uygulamandan doğrudan yol tarifi açabilirsin.",
		},
	...
	},
	{
		...
		secondary: []landingAction{
			...
			{href: "/ders-programi-nasil-hazirlanir/", label: "Ders programını nasıl hazırlarsın", detail: "Ders planından çakışmasız haftalık programa giden yolu adım adım izle."},
			{href: "/terimler-sozlugu/", label: "Terimler sözlüğüne bak", detail: "CRN, ÖBS, SİS gibi kısaltmaların ne anlama geldiğini gör."},
	...
	},
	{
		...
		secondary: []landingAction{
			{href: "/bolumler/", label: "Bölümünün ders planını bul", detail: "Fakülte ve bölüm seçerek müfredatını yarıyıl yarıyıl incele."},
			{href: "/#onsart", label: "Önşartları kontrol et", detail: "Program haritasında dersin geriye doğru bağlantılarını izle."},
			{href: "/ders-arsivi/", label: "Kontenjan ve doluluk geçmişini incele", detail: "Bir dersin geçmiş dönemlerde ne kadar hızlı dolduğunu gör."},
			{href: "/ders-programi-olustur/", label: "Program oluşturma aracının tüm özelliklerini gör", detail: "Alternatif Bul ve dışa aktarma gibi özellikleri incele."},
			{href: "/ders-kaydi-nasil-yapilir/", label: "Resmî kayıt sürecini öğren", detail: "Hazırlıktan kayıt anına kadar tüm OBS/SİS sürecini adım adım gör."},
		},
	...
	},
	{
		...
		secondary: []landingAction{
			...
			{href: "/ders-programi-nasil-hazirlanir/", label: "Ders programı nasıl hazırlanır", detail: "Ders planından çakışmasız haftalık programa giden yolu izle."},
			{href: "/ders-secimi/", label: "Ders seçimi adımlarını gör", detail: "Dersleri arayıp programını kurmadan önce izleyeceğin dört adımı gör."},
		},
