import{$,esc,fmtDate}from"../core/utils.js?v=9dbaeb11b05e";import{state}from"../core/store.js?v=9dbaeb11b05e";import{initReveal}from"../core/reveal.js?v=9dbaeb11b05e";import{I18N}from"../i18n.js?v=9dbaeb11b05e";const KNOWN_GAPS={"2024-2025-guz":"termGap20242025Guz"};function localizedTermLabel(e,t){if(I18N.lang!=="en")return e;const n=/^(.+)-(guz|bahar|yaz)$/.exec(t||"");if(!n)return e;const s={guz:"Fall Term",bahar:"Spring Term",yaz:"Summer Term"}[n[2]];return`${n[1]} ${s}`}export function renderTerms(){$("#terms").innerHTML=state.index.terms.map(e=>{const t=localizedTermLabel(e.label,e.slug);if(e.missing){const n=KNOWN_GAPS[e.slug],s=n?I18N.t(n):I18N.t("termNoDataFallback");return`<article class="termcard reveal missing">
